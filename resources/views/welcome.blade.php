                ...
                <nav class="navbar navbar-inverse navbar-toggleable-md">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-center" id="Forest Timemenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link color-green-hover" href="{{ route('team') }}">Our Team</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="masonry-box post-media">
                            ...
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="{{ route('category') }}"
                                                                 title="">Gardening</a></span>
                                        <h4><a href="{{ route('single') }}" title="">How to choose high quality soil for
                                                your gardens</a></h4>
                                        <small><a href="{{ route('single') }}" title="">21 July, 2017</a></small>
                        ...
                        <div class="masonry-box post-media">
                            ...
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="{{ route('category') }}"
                                                                 title="">Outdoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">You can create a garden with furniture
                                                in your home</a></h4>
                                        <small><a href="{{ route('single') }}" title="">19 July, 2017</a></small>
                                        <small><a href="#" title="">by Amanda</a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                            ...
                            <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        ...
                                        <h4><a href="{{ route('single') }}" title="">The success of the 10 companies in the
                                                vegetable sector</a></h4>
                                        <small><a href="{{ route('single') }}" title="">03 July, 2017</a></small>
                            ...
                            <div class="blog-list clearfix">
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">The best twenty plant species you can
                                        ...
                                        <small><a href="{{ route('category') }}" title=""><i class="fa fa-eye"></i>
                                                1887</a></small>
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">How do you like the idea of creating a
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">Top 20 cafeterias decorated with
                                                quality plants</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim
                                            nibh, maximus ac felis nec, maximus tempor odio.</p>
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">30 beautiful flowers you can look at
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">Enjoy your living room with small
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">Why do you prefer small flowers at
                                                your workplace?</a></h4>
                                        <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                            pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim
                                            nibh, maximus ac felis nec, maximus tempor odio.</p>
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">10 special plant species available to
                                ...
                                <div class="blog-box row">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <span class="bg-aqua"><a href="{{ route('category') }}" title="">Indoor</a></span>
                                        <h4><a href="{{ route('single') }}" title="">Selection of high quality soil for
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="{{ route('home') }}"><img src="images/version/garden-footer-logo.png" alt=""
                                                                   class="img-fluid"></a>
