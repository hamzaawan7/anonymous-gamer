...
@section('content')
    ...
    <h2 style="padding-left: 110px"><u>Top News</u></h2>
    <section class="section first-section" style="padding-top: 10px;padding-left: 110px;padding-right: 20px">
...
{{--                                        <small><a href="#" title="">{{ $post->user->name  }}</a></small>--}}
    ...
    <h2 style="padding-left: 110px"><u>Top Blogs</u></h2>
