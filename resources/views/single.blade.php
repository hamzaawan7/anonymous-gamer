                ...
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                    <div class="page-wrapper">
                        <div class="blog-title-area">
                            <span class="color-green"><a href="{{ route('category') }}" title="">Gardening</a></span>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="{{ route('single') }}" title="">We are guests of ABC Design Studio</a></h4>
                                            <small><a href="{{ route('category') }}" title="">Trends</a></small>
                                            <small><a href="{{ route('category') }}" title="">21 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                                ...
                                <div class="col-lg-6">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta">
                                            <h4><a href="{{ route('single') }}" title="">Nostalgia at work with family</a></h4>
                                            <small><a href="{{ route('category') }}" title="">News</a></small>
                                            <small><a href="{{ route('category') }}" title="">20 July, 2017</a></small>
                                        </div><!-- end meta -->
                                    </div><!-- end blog-box -->
                                </div><!-- end col -->
                            </div><!-- end row -->
