            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="auth">
                        ...
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin-category') }}">Category </a>
                            </li>
                        </ul>

{{--                        <ul class="nav flex-column sub-menu">--}}
{{--                            <li class="nav-item"><a class="nav-link" href="{{ route('admin-post') }}">Posts </a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}

{{--                        <ul class="nav flex-column sub-menu">--}}
{{--                            <li class="nav-item"><a class="nav-link" href="{{ route('admin-reviews') }}">Reviews </a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
